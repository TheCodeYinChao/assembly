...
package cn.bainuo.assembly.data.exception;
...
public class GlobalExceptionHandler {
	...
	public Object defaultErrorHandler(HttpServletRequest request, HttpServletResponse response,
		...
		if(ex instanceof ServiceException){
			...
			GlobalErrorCode systemError = GlobalErrorCode.SYSTEM_ERROR;
			rv = new ResultVo(systemError.getCode(),systemError.getMessage(),null);
