...
import com.raydata.model.UserTaskNodeInfo;
...
public class ImaGegenerateUtils {
    ...
    public static InputStream gegenerate(List<UserTaskInfo> userTasks, String currentNode, List<String> activeActivityIds,
        ...
        // 代表生成图片
        in = new ProcessDiagramGenerator().generateDiagram(bpmnModel, "png", activeActivityIds, highLightedFlows,
                "宋体", "宋体", "宋体", null, 1.0);
        return in;
    }
